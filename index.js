...
const store = MongoStore.create({
  mongoUrl: dbUrl,
  touchAfter: 24 * 60 * 60, //if data is the same, only refresh or update after 24 hours
  crypto: {
...
const sessionConfig = {
  store,
  name: 'session', //set default session cookie name, so that session.id is not default
